class Main {
    companion object {
        ...
        fun main(args: Array<String>) {
            ...
            print(Gauss.solve(matrix, doubleArrayOf(10.5, 16.0, 38.0)))
            print("\n\n${ANSI_YELLOW}Jacobi method :${ANSI_RESET}")
            print(Jacobi.solve(matrix, doubleArrayOf(10.5, 16.0, 38.0)))
            print("\n\n${ANSI_YELLOW}Seidel method :${ANSI_RESET}")
            print(Seidel.solve(matrix, doubleArrayOf(10.5, 16.0, 38.0)))
        }
    }
}